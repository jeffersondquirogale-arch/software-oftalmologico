  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' }}>
        <div>
          <label style={S.label}>Cover Test VL</label>
          <input type="text" value={historia.coverTest_vl || ''} onChange={set('coverTest_vl')} style={S.input} onFocus={S.onFocus} onBlur={S.onBlur} />
        </div>
        <div>
          <label style={S.label}>Cover Test VP</label>
          <input type="text" value={historia.coverTest_vp || ''} onChange={set('coverTest_vp')} style={S.input} onFocus={S.onFocus} onBlur={S.onBlur} />
        </div>
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' }}>
        <div>
          <label style={S.label}>Kappa OD</label>
          <input type="text" value={historia.kappaOD || ''} onChange={set('kappaOD')} style={S.input} onFocus={S.onFocus} onBlur={S.onBlur} />
        </div>
        <div>
          <label style={S.label}>Kappa OI</label>
          <input type="text" value={historia.kappaOI || ''} onChange={set('kappaOI')} style={S.input} onFocus={S.onFocus} onBlur={S.onBlur} />
        </div>
      </div>

      {/* DUC / Versiones */}
      <div>
        <label style={S.label}>DUC / Versiones</label>
